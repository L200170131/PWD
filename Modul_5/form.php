...
<body>
	<center>
		...
		<table border="0" width="30%">
			...
			<td width="5%">:</td>
			<td width="65%"><input type="radio" value="A" checked name="kelas">A<input type="radio" value="B" name="kelas">B<input type="radio" value="C" name="kelas">C</td></tr>
		...
		<table border="1" width="50%">
			...
			<?php
				$cari = "SELECT*FROM mahasiswa order by nim"; $hasil_cari=mysqli_query($conn,$cari); 
